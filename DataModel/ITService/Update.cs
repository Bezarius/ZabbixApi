namespace ZabbixApi.DataModel.ITService
{
    public class Update : ITService
    {
        ...
        /// <summary>
        /// Service times to replace the current service times.
        /// </summary>
        public string[] times;
    }
}