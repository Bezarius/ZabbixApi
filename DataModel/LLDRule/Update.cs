namespace ZabbixApi.DataModel.LLDRule
{
    public class Update : LLDRule
    {
        ...
        public Update(int delay, string hostid, string interfaceid, string key_, string name, int type) : base(delay, hostid, interfaceid, key_, name, type)
        {
        }
    }
}