...
{
    public class Create : ItemPrototype
    {
        /// <summary>
        /// </summary>
        ...
        /// 3 - numeric unsigned;
        /// 4 - text.</param>
        ///<param name="ruleid">ID of the LLD rule that the item belongs to.</param>
        public Create(int delay, string hostid, string interfaceid, string key_, string name, int type, int value_type, string ruleid)
